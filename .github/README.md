...
[`@aws-sdk/client-amplify`](https://www.npmjs.com/package/@aws-sdk/client-amplify/v/3.856.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplify@3.856.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L4l4IfVVe7DUpLbJ2+iUegbJ2WfF8+OWhcBqu6Qtwf6ESQITDcAgN3fFegPqFZpY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplify": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplify@3.856.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplify@3.856.0/index.min.mjs": "sha384-L4l4IfVVe7DUpLbJ2+iUegbJ2WfF8+OWhcBqu6Qtwf6ESQITDcAgN3fFegPqFZpY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplify/blob/refs/tags/3.856.0/LICENSE
```
